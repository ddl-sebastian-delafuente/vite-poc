...
class ControlCenterIcon extends Icon<{}> {
  public static defaultProps: IconProps = {
    className: '',
    fill: 'currentColor',
    height: 15,
    width: 15,
    viewBox: '0 0 33.637 33.637',
