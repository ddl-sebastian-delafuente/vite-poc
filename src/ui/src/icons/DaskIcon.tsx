...
class DaskIcon extends Icon<{}> {
  ...
  id1 = `dask-${getUniqueId()}`;
  id2 = `dask-${getUniqueId()}`;
  id3 = `dask-${getUniqueId()}`;
      ...
      <g>
        <defs>
          ...
          >
            ...
            <stop offset="1.00" stopColor="#eeb575"/>
          </linearGradient>
          <linearGradient
            id={`${this.id2}`}
            x1="297.68"
        ...
        />
        <path
          d="M323.44,228.19c8-17.75,16.39-61.85,15.86-65.14a245.35,245.35,0,0,1-29.41,43.59c-1.65,4.37-3.39,8.7-5.33,13h0A211.92,211.92,0,0,1,243,298.41q1.65,11.94,2.09,24.05A232.43,232.43,0,0,0,323.44,228.19Z"
          fill={`url(#${this.id2})`}
        />
        <path
          d="M201.14,324.23a212.21,212.21,0,0,1-60.09,17.84l-11.83,1.67,6-10.33A235,235,0,0,0,146,312.5a231.24,231.24,0,0,0,20.68-87.35l0.18-4.89,4.85-.65a234,234,0,0,0,105.16-41.79,200.09,200.09,0,0,0,36.17-65,212.27,212.27,0,0,1-157.36,87.56l-9.89.69L146,211a210.08,210.08,0,0,1-18.92,92.92,213,213,0,0,1-26.92,44.14L87.13,364.6l21.07,0.28a232.13,232.13,0,0,0,92.5-18A202.86,202.86,0,0,0,201.14,324.23Z"
          fill={`url(#${this.id3})`}
        />
      </g>
    );
